...
//import be.bastienhousiaux.quizz.routes.models.requests.MemoryCardListDeleteRequest;
//import lombok.val;
...
//
//    @DeleteMapping("/{id}")
//    public void deleteMemoryCardList(@PathVariable long id){
//        this.memoryCardListService.deleteMemoryCardList(id);
//    }
//
//
//
